...
from glue_eval.useful_functions import load_data, load_data_split, get_model_max_context_length
import time
import torch
import numpy as np
...
class SENTIMENT_ANALYSIS_Eval():
    ...
    def _create_prompt(self, example, gen_len):
        ...
        remaining_token_length = get_model_max_context_length(self.model, self.tokenizer) - question_token_length - gen_len
        actual_few_shot = ""
...
if __name__ == '__main__':
    ...
    result_dict, _stored_generations = sentiment_analysis_eval.evaluate(print_logs=True)
